...
import com.github.wolf480pl.mias4j.util.NullClassLoader;
...
public class Wrap {
    ...
    public static void main(String[] args) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, ClassNotFoundException, MalformedURLException, URISyntaxException {
        ...
        Transformer t = null;
        t = bypass ? new SandboxTransformer(SandboxTransformer.wrapIfJava8(BlindPolicy.NEVER_INTERCEPT)) : new SandboxTransformer();
        // t = bypass ? new SandboxTransformer(new ChangeMindPolicy(false)) : new SandboxTransformer(new ChangeMindPolicy(true));
